...
function incidents() {
  return `${header("Operational<br>incident command.", "No open incident source is connected. The center will not manufacture failures or claim real-time monitoring.", "INCIDENTS")}<section class="panel"><div class="empty-state"><b>NO INCIDENT FEED CONNECTED</b><p>Production monitoring and alert ingestion require an authenticated server-side integration.</p></div></section>`;
}
function commercial() {
