...
export const STOREFRONT_ITEMS_DATA: StorefrontItem[] = [
  ...
  },
  {
    ...
    listingAssetPack: 'Public Whop buyer page verified with product gallery and FAQs; authenticated seller plan read-back passed; fulfillment blocked because no Whop experience is attached',
    orderCount: 0,
    deliveryFormat: 'Public purchase path verified via Whop Order now; entitlement/fulfillment requires seller-side QA',
    buyerQaStatus: 'VERIFIED',
    buyerQaVerifiedAt: '2026-09-04T00:13:00Z',
    ...
    sellerQaStatus: 'PENDING',
    sellerQaEvidence: 'Authenticated Whop read-back 2026-09-04: account biz_1s3AzoabzwjpqM (The OCG LAB), product prod_EEmswqofRNOpM, plan plan_ep13hdJeMHRfW, visible one-time buy_now $29.00. Fulfillment BLOCKED: GET /experiences returned zero attached experiences for this product.',
  },
  {
    ...
    listingAssetPack: 'Public Whop buyer page verified with FAQs; authenticated seller plan read-back passed; fulfillment blocked because no Whop experience is attached',
    orderCount: 0,
    deliveryFormat: 'Public purchase path verified via Whop Order now; entitlement/fulfillment requires seller-side QA',
    buyerQaStatus: 'VERIFIED',
    buyerQaVerifiedAt: '2026-09-04T00:13:00Z',
    ...
    sellerQaStatus: 'PENDING',
    sellerQaEvidence: 'Authenticated Whop read-back 2026-09-04: account biz_1s3AzoabzwjpqM (The OCG LAB), product prod_Kma1MiZdJXFBv, plan plan_PhwwSWqwyRCQq, visible one-time buy_now $99.99. Fulfillment BLOCKED: GET /experiences returned zero attached experiences for this product.',
  },
  {
