...
export const PORTFOLIO_DATA: PortfolioItem[] = [
  // LADDER 1: DIGITAL PLAYBOOKS (Insurance Agent is Master Standard)
  {
    ...
    pricing: { tier: 'LOW', amount: 19, billing: 'one-time' },
    channels: ['Etsy', 'Whop', 'Direct'],
    deliveryAsset: 'OCG_LAB_Insurance_Agent_ETSY_COMPLETE_PACKAGE_FINAL.zip',
    productionUrl: 'https://ocg-lab-products.vercel.app/playbooks/insurance-agent/',
    leadAgent: 'Piper',
    featured: true
  },
  {
    ...
    pricing: { tier: 'LOW', amount: 19.99, billing: 'one-time' },
    channels: ['Etsy', 'Whop', 'Direct'],
    deliveryAsset: 'real-estate-investor-ai-playbook-FINAL.html',
    productionUrl: 'https://ocg-lab-products.vercel.app/playbooks/real-estate-investor/',
    leadAgent: 'Victor',
    featured: true
  },
  {
  ...
  },
  {
    ...
    pricing: { tier: 'MID', amount: 29, billing: 'one-time' },
    channels: ['Whop', 'Direct'],
  ...
  },
  {
    ...
    pricing: { tier: 'MID', amount: 99.99, billing: 'one-time' },
    channels: ['Whop', 'Direct'],
